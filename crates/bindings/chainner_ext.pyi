...
class RustRegex:
    ...
    def search(self, text: str, pos: int = 0) -> RustRegexMatch | None: ...
    def findall(self, text: str) -> List[RustRegexMatch]: ...
    def split(self, group_name: str) -> List[str]: ...
    def split_without_captures(self, group_name: str) -> List[str]: ...

class RustRegexMatch:
    @property
    def start(self) -> int: ...
    @property
    def end(self) -> int: ...
    @property
    def len(self) -> int: ...
    def get(self, group_index: int) -> RustRegexGroup | None: ...
    def get_by_name(self, group_name: str) -> RustRegexGroup | None: ...

class RustRegexGroup:
    @property
    def start(self) -> int: ...
    @property
    def end(self) -> int: ...
